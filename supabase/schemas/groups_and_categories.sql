...
CREATE POLICY "Enable update their own data only" ON "public"."groups" AS PERMISSIVE
FOR UPDATE
...
CREATE POLICY "Enable update their own data only" ON "public"."categories" AS PERMISSIVE
FOR UPDATE
  TO authenticated USING (
    (
      user_id = (
