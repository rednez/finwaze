drop function if exists "public"."get_filtered_transactions"(p_category_ids bigint[], p_account_ids bigint[], p_charged_currency_codes text[], p_transaction_currency_codes text[], p_month date, p_page integer, p_page_size integer);
