...
import { InstagramLink } from './ui/instagram-link';
...
import { ThreadsLink } from './ui/threads-link';
import { WhiteButton } from './ui/white-button/white-button';
import { XLink } from './ui/x-link';
...
export class Landing {
  ...
  protected readonly heroBadges = computed(
    () => TRANSLATIONS[this.lang()].landing.heroBadges,
  );
  protected readonly stats = computed(
    () => TRANSLATIONS[this.lang()].landing.stats,
  );
  protected readonly sectionsData = computed(
    () => TRANSLATIONS[this.lang()].landing.sectionsData,
  );
  protected readonly howItWorksSteps = computed(
    () => TRANSLATIONS[this.lang()].landing.howItWorksSteps,
  );
  protected readonly testimonials = computed(
    () => TRANSLATIONS[this.lang()].landing.testimonialsList,
  );
